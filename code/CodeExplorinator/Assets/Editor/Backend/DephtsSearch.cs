...
namespace CodeExplorinator
{
    public static class DephtsSearch
    {
        ...
        public static Dictionary<IClassData, ImmutableHashSet<IClassData>> Start(IClassData focusClass, int radius,
            ImmutableHashSet<ClassData> allClasses)
        {
            ...
            {
                HashSet<IClassData> connectedClasses =
                    ClassAnalyzer.AnalyzeConnectionsOfClass(incompleteClass.typeData, allClasses);
            ...
            void DepthSearch(IClassData focusClass, int radius)
            {
                ...
                ImmutableHashSet<IClassData> connectedClasses = ClassAnalyzer
                    .AnalyzeConnectionsOfClass(focusClass.typeData, allClasses).ToImmutableHashSet();
